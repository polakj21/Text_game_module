...
foword((výpis možností),((název_možnosti),(room #str#),(dir),((kdy),(vjakém stavu #bool#)),(text)),(--||--)) #není li žádná možnost, napište jen text do výpis možností. musí však zaèínat na !, pokud pak je v tomto pøípadì pouze jeden string, unìlejte z toho tuple tím, že za nìj dáte > , <
